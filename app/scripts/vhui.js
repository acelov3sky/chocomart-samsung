module.exports = function() {
     ...
     *
     * Functions which handle vital UI functionality such as main navigation and layout They are auto initialized in every page
     *
     *********************************************************************************************
     */
    ...
    var uiInit = function() {
        ...
        jQuery('[data-height-as]').each(function(){
            var $this = $(this);
            $this.css({ 'min-height': $($this.attr('data-height-as')).height()});
        });
    };
    ...
    var uiToggleFilter = function() {
        jQuery('[data-toggle="filter"]').each(function(){
        ...
        initHelpers: function($helpers) {
            if ($helpers instanceof Array) {
                for(var $index in $helpers) {
                    this.initHelper($helpers[$index]);
                }
            } else {
                this.initHelper($helpers);
            }
        }
    };
}
